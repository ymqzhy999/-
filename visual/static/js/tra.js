...
function show_data(page_data, page_no, page_list) {
    ...
    if (page_no == 1) {
        ...
        page_str = '<span class="prev" onclick="get_tra_data(' + (page_no - 1) + ')">&lt;&lt;</span>';
    }
    for (var i = 0; i < page_list.length; i++) {
        ...
        if (item == page_no) {
            ...
            page_str = page_str + '<span class="num" onclick="get_tra_data(' + item + ')">' + item + '</span>'
        }
    }
    if (page_no != max_page) {
        page_str = page_str + ' <span class="next" onclick="get_tra_data(' + (page_no + 1) + ')">&gt;&gt;</span>'
    }

    $("#tra_data").html(list_data);
